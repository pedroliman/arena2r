...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/arena2r)](https://cran.r-project.org/package=arena2r) [![Travis-CI Build Status](http://travis-ci.org/pedroliman/arena2r.svg?branch=master)](https://travis-ci.org/pedroliman/arena2r) [![Coverage Status](https://img.shields.io/codecov/c/github/pedroliman/arena2r/master.svg)](https://codecov.io/github/pedroliman/arena2r?branch=master)
...
You can install arena2r with:

```{r gh-installation, eval = FALSE}
install.packages("arena2r")

# You may also install the development version with:
